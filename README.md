...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typed-argument-parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13104&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typed-argument-parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typed-argument-parser` can be installed with:

```
conda install typed-argument-parser
```

It is possible to list all of the versions of `typed-argument-parser` available on your platform with:
